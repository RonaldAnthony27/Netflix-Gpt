...
const PlayVideo = () => {
    ...
    const title = async () => {
        const data = await fetch("https://api.themoviedb.org/3/movie/"+movieId,MOVIE_OPTIONS)
    ...
    return (
       ...
       <Link to="/"> <img className='absolute z-20 w-44 cursor-pointer' src={LOGO} alt='logo'/> </Link> 
        <div className='w-screen -mt-24 absolute aspect-video'>
          <iframe
